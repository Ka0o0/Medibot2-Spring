 ...
 */
@Service
class PauseAlarmCommandHandler : ChatStateTransitionHandler {
    override fun processTransition(chat: Chat, transitionPayload: Any?): Triple<ChatState, ChatStatePayload?, StateMachineResponse> {
        return Triple(ChatState.AwaitingNameForOperation, AlarmCommandStatePayload(AlarmCommandStatePayload.AlarmCommand.Pause), StateMachineResponse.AWAITING_ALARM_SELECTION)
    }
}