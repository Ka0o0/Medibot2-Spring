 ...
 */
@Service
class DeleteAlarmCommandHandler : ChatStateTransitionHandler {
    override fun processTransition(chat: Chat, transitionPayload: Any?): Triple<ChatState, ChatStatePayload?, StateMachineResponse> {
        return Triple(ChatState.AwaitingNameForOperation, AlarmCommandStatePayload(AlarmCommandStatePayload.AlarmCommand.Delete), StateMachineResponse.AWAITING_ALARM_SELECTION)
    }
}